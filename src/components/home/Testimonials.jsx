    ...
    return (
        <section className="mx-auto mt-6 w-[min(1280px,94vw)] rounded-[24px] border border-[#DCE3E6] bg-[#F2F6F7] p-6 md:p-9">
            ...
            <div className="mt-6 grid gap-4 lg:grid-cols-2">
                {[
                    'After installing the Nature Organic Energy pellet burner system, our textile factory reduced fuel costs by nearly 45 percent while maintaining consistent heating output.',
