    ...
    return (
        <section className="mx-auto mt-6 w-[min(1280px,94vw)] rounded-[24px] border border-[#DCE3E6] bg-[#FDFEFD] overflow-hidden">
            <div className="grid lg:grid-cols-[1.4fr_1fr]">
                <Reveal className="relative h-64 lg:h-full min-h-[400px] overflow-hidden bg-[#1e2d38] flex items-center justify-center">
                    {post.video ? (
                        <>
                    ...
                    {/* Gradient and Label */}
                    <div className="absolute inset-0 z-20 bg-gradient-to-t from-black/90 via-black/20 to-transparent p-6 lg:p-10 flex flex-col justify-end">
                        <span className="w-fit rounded-full bg-[#078DA4] px-4 py-1 text-[10px] font-bold uppercase tracking-widest text-white shadow-lg">Editor's Choice</span>
